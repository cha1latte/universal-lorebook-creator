...
Works with Claude, ChatGPT, Gemini, DeepSeek, and other AI assistants.
...
with three districts and a hacker protagonist named Cipher."

AI: [Generates complete lorebook JSON]
```

Save as `.json` and import to SillyTavern.
